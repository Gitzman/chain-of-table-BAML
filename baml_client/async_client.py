...
class BamlAsyncClient:
    ...
    async def GroupColumn(
        self,
        table_text: str,statement: str,columns: List[str],
        baml_options: BamlCallOptions = {},
    ) -> types.GroupColumnResult:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb
      else:
    ...
    async def SelectRows(
      ...
      mdl = create_model("SelectRowsReturnType", inner=(types.SelectRowResult, ...))
      return coerce(mdl, raw.parsed())
    
    async def SortColumn(
        self,
        table_text: str,statement: str,columns: List[str],
        baml_options: BamlCallOptions = {},
    ) -> types.SortColumnResult:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb
      else:
      ...
      mdl = create_model("SortColumnReturnType", inner=(types.SortColumnResult, ...))
      return coerce(mdl, raw.parsed())
...
class BamlStreamClient:
    ...
    def FinalQuery(
        ...
        table_text: str,statement: str,columns: List[str],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.FinalQueryResult, types.FinalQueryResult]:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb
      else:
      ...
      return baml_py.BamlStream[partial_types.FinalQueryResult, types.FinalQueryResult](
        raw,
    ...
    def GroupColumn(
        ...
        table_text: str,statement: str,columns: List[str],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.GroupColumnResult, types.GroupColumnResult]:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb
      else:
    ...
    def Planner(
        ...
        table_text: str,statement: str,columns: List[str],operation_history: List[str],possible_next_operations: List[types.FunctionDemo],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.PlannerResult, types.PlannerResult]:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb
      else:
      ...
      return baml_py.BamlStream[partial_types.PlannerResult, types.PlannerResult](
        raw,
        lambda x: coerce(partial_mdl, x),
        lambda x: coerce(mdl, x),
        self.__ctx_manager.get(),
    ...
    def SelectRows(
        ...
        table_text: str,statement: str,columns: List[str],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.SelectRowResult, types.SelectRowResult]:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb
      else:
      ...
      mdl = create_model("SelectRowsReturnType", inner=(types.SelectRowResult, ...))
      partial_mdl = create_model("SelectRowsPartialReturnType", inner=(partial_types.SelectRowResult, ...))

      return baml_py.BamlStream[partial_types.SelectRowResult, types.SelectRowResult](
        raw,
        lambda x: coerce(partial_mdl, x),
        lambda x: coerce(mdl, x),
        self.__ctx_manager.get(),
    ...
    def SortColumn(
        ...
        table_text: str,statement: str,columns: List[str],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.SortColumnResult, types.SortColumnResult]:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb
      else:
      ...
      mdl = create_model("SortColumnReturnType", inner=(types.SortColumnResult, ...))
      partial_mdl = create_model("SortColumnPartialReturnType", inner=(partial_types.SortColumnResult, ...))

      return baml_py.BamlStream[partial_types.SortColumnResult, types.SortColumnResult](
        raw,
        lambda x: coerce(partial_mdl, x),
        lambda x: coerce(mdl, x),
        self.__ctx_manager.get(),
